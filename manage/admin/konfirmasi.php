...
// Ubah query untuk memeriksa transaksi yang hanya terkait dengan outlet yang sedang aktif dan status_bayar 'belum' atau 'pending'
$data = mysqli_query($conn, "SELECT transaksi.*, pelanggan.nama_pelanggan, detail_transaksi.total_harga, transaksi.biaya_tambahan, transaksi.pajak, transaksi.diskon 
                            ...
                            WHERE transaksi.status_bayar IN ('belum', 'pending') 
