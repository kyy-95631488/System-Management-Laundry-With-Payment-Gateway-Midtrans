...
if (isset($_POST['btn-simpan'])) {
    ...
    $no_ktp = !empty($_POST['no_ktp']) ? $_POST['no_ktp'] : null; // Memastikan No KTP tidak kosong
    $telp = $_POST['telp_pelanggan'];
    $jenis_kelamin = $_POST['jenis_kelamin'];
    
    // Modifikasi query INSERT untuk menangani No KTP yang kosong
    if ($no_ktp !== null) {
                    ...
                    <form action="" method="POST">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="largeInput">No KTP Pelanggan <small>(Opsional)</small></label>
